...
namespace DependencyInjection
{
    public static class DependencyService
    {
        ...
        {
            if (DependencyRepository.ContainsKey(typeof(T)) && force == false) return false;
        ...
        {
            if (DependencyRepository.TryGetValue(typeof(T), out var dependency)) return (T) dependency.GetDependency();
        ...
        {
            if (DependencyRepository.TryGetValue(t, out var dependency)) return dependency.GetDependency();
            throw new ServiceNotRegistered($"{nameof(t)} is not registered as a Dependency / Service");
        }
    }
}